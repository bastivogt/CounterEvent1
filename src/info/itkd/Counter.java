...
public class Counter {
    ...
    private CounterStartHandler counterStartHandler = null;
    private CounterChangeHandler counterChangeHandler = null;
    private CounterFinishHandler counterFinishHandler = null;
    ...
    public void setCounterStartHandler(CounterStartHandler counterStartHandler) {
        this.counterStartHandler = counterStartHandler;
    }

    public void setCounterChangeHandler(CounterChangeHandler counterChangeHandler) {
        this.counterChangeHandler = counterChangeHandler;
    }

    public void setCounterFinishHandler(CounterFinishHandler counterFinishHandler) {
